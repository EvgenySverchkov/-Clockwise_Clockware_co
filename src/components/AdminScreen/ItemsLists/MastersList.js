...
import {initMasters, deleteMasterFromState, townsInit} from "../../../store/adminPanel/actions";
import deleteDataFromServer from "../services/deleteDataFromServer";
import List from "../List";

import { SERVERDOMAIN } from "../../../services/serverUrls";

const MastersList = ({mastersArr, deleteMasterFromState, initMasters, townsInit, history}) => {
