...
import {changeEditFormIsLoad, updateOrderInState} from "../../../store/adminPanel/actions";
...
const EditOrderForm = ({match, history, ordersArr, changeEditFormIsLoad, updateOrderInState}) => {
