...
import {changeEditFormIsLoad, updateTownInState} from "../../../store/adminPanel/actions";
...
const EditTownForm = ({match, history, townsArr, changeEditFormIsLoad, updateTownInState})=>{
