...
const SuccessModal = ({history, data}) => {
  return (
    <div className="modal fade" id="successModal" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <h4 className="modal-title display-4 text-success" id="successModalLabel">
      ...
      <div className="modal-footer">
        <button type="button" className="btn btn-secondary" data-dismiss="modal" onClick={()=>{history.push(data.backTo)}}>
